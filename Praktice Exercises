...
### When is it appropriate for the operating system to forsake efficiency and "waste" resources? Why is such a system not really wasteful?
**Answer:**  
...
### Should the operating system include applications such as web browsers and mail programs?
**Answer:**  
...
### Describe two difficulties that arise from placing the OS in a memory partition that cannot be modified by the user or OS itself.
**Answer:**  
...
### What are two possible uses of multiple modes of operation in CPUs?
**Answer:**  
